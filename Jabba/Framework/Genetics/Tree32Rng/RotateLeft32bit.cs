...
{
    /// <summary>
    /// Rotate left node for tree-based genetic programming.
    /// </summary>
    [Serializable]
    public class RotateLeft32Node : TreeNode
    {
        public RotateLeft32Node(TreeNode left, TreeNode right)
        {
        ...
        protected override TreeNode FoldInternal()
        {
            ...
            {
                return new ConstantNode32bit(GeneticHelper.RotaterLeft(c1.Value, c2.Value));
            }
