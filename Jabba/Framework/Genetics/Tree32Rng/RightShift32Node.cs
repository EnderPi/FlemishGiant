...
{
    /// <summary>
    /// Right shift node for tree-based programming of 32 bit integers.
    /// </summary>
    [Serializable]
    public class RightShift32Node : TreeNode
    {
        public RightShift32Node(TreeNode left, TreeNode right)
        {
