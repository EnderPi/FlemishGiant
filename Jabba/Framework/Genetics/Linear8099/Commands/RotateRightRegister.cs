...
namespace EnderPi.Genetics.Linear8099.Commands
{
    ...
    public class RotateRightRegister : BinaryRegisterRegisterCommand
    {
        ...
        {
            registers[_targetRegisterIndex] = GeneticHelper.RotaterRight(registers[_targetRegisterIndex], registers[_sourceRegisterIndex]);
        }
        ...
        {
            return $"{LinearGeneticHelper.GetRegister(_targetRegisterIndex)} = BitOperations.RotateRight({LinearGeneticHelper.GetRegister(_targetRegisterIndex)}, (int)({LinearGeneticHelper.GetRegister(_sourceRegisterIndex)} & 63UL));";
        }
    }
}
